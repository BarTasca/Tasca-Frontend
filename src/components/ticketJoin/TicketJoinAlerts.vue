    ...
    >
      <template #prepend>
        <svg
          ...
          class="lucide lucide-squirrel-icon lucide-squirrel"
        >
      ...
      <template v-if="queueAhead.ahead === 0"> Eres el siguiente </template>
      <template v-else> {{ queueAhead.ahead }} mesas por delante </template>
    </v-alert>
  </div>
</template>
